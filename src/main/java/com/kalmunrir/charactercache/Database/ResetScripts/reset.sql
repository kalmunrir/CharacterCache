...
create table if not exists CharacterSpellSlots (
    id integer primary key autoincrement not null unique,
    totalFirstLevelSS integer not null,
    totalSecondLevelSS integer not null,
    totalThirdLevelSS integer not null,
    totalFourthLevelSS integer not null,
    totalFifthLevelSS integer not null,
    totalSixthLevelSS integer not null,
    totalSeventhLevelSS integer not null,
    totalEighthLevelSS integer not null,
    totalNinthLevelSS integer not null,
    currentFirstLevelSS integer not null,
    currentSecondLevelSS integer not null,
    currentThirdLevelSS integer not null,
    currentFourthLevelSS integer not null,
    currentFifthLevelSS integer not null,
    currentSixthLevelSS integer not null,
    currentSeventhLevelSS integer not null,
    currentEighthLevelSS integer not null,
    currentNinthLevelSS integer not null,
    characterId integer not null,
    foreign key (characterId) references Characters (id) on delete cascade
);
